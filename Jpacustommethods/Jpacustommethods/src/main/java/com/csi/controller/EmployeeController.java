...
public class EmployeeController {
    ...
    @GetMapping("/getdatabyempName/{empFirstName}")
    public ResponseEntity<List<Employee>>getDataByEmpName(@PathVariable String empFirstName){
    ...
    @GetMapping("/getdatabyempfirstnameandemplastname/{empFirstName}/{empLastName}")
